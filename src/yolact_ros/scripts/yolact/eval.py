...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default=r'/home/wxl/anaconda3/jupyter-notebook/yolact/yolact_plus_resnet50_54_800000.pth', type=str,
    ...
    parser.add_argument('--config', default='yolact_plus_resnet50_config', # None
    ...
    parser.add_argument('--score_threshold', default=0.15, type=float, # 0
...
def prep_process(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    """
...
def load_net(argv = None):
    ...
    with torch.no_grad():
        ...
        net.eval()
        print(' Done.')
        print('Load Model ues {} ms'.format(round((time.time()-start)*1000)))
